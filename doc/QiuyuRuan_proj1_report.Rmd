...
packages.used=c("tm", "wordcloud", "RColorBrewer", 
                "dplyr", "tidytext","textdata","reshape2","ggplot2")
...
**So whether different music genres have their own attitudes?For example, is it true that hip-hop music is more negative while pop music is more positive according to our common sense?** In order to explore this problem, I decide to conduct sentiment analysis on song lyrics.
